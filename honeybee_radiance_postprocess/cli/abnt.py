...
def abnt_nbr_15575(
    ...
    try:
        ...
        for _res_folder in folder_names:
            res_folder = folder.joinpath(_res_folder)
            ...
            for grid_info in grids_info:
                ...
                mesh_center = np.array([sensor_grid.mesh.center.x, sensor_grid.mesh.center.y])
                ...
                if f_xy >= 120:
                    ...
                    print('Intermediario', f_xy)
                elif f_xy >= 60:
                    print('Minimo', f_xy)
                else:
                    print('Nao atende', f_xy)
